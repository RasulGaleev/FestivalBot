...
from .platform import platform_handler, platform_filter_handler, platform_schedule_handler, \
    platform_infrastructure_handler
...
def register_client_handlers(router: Router) -> None:
    ...
    router.callback_query.register(platform_schedule_handler, F.data == "platform_schedule")
